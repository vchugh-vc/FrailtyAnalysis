...
new = y = butter_lowpass_filter(AccY, DataFeatures.FFTFreq * 10, SAMPLE_FREQ, 6)
plt.subplot(2,1,1)
plt.plot(AccY)
plt.ylim(-1,1)
plt.subplot(2,1,2)
...
def minmax_spread(array):  # Returns Min-Max Data of an Array
    ...
    print(f"Max: {max_data}, Min: {min_data}, Range : {minmax_data}, Peak {peak_data}, RMS {rms_data}, STD {std_data}, Var {var_data}")
